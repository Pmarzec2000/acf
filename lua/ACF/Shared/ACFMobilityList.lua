...
local EngineGTsmall = {}
	...
	EngineGTsmall.name = "Small Gas Turbine"
	EngineGTsmall.desc = "A tiny gas turbine, excessively noisy and thirsty"
	EngineGTsmall.model = "models/engines/gasturbine_s.mdl"
	EngineGTsmall.sound = "GT.Small"
	EngineGTsmall.category = "Turbine"
	EngineGTsmall.weight = 40
	EngineGTsmall.torque = 200	
    EngineGTsmall.flywheelmass = 2.5		--in Meter/Kg
	EngineGTsmall.idlerpm = 1000	--in Rotations Per Minute
	EngineGTsmall.peakminrpm = 1000
	EngineGTsmall.peakmaxrpm = 4000
