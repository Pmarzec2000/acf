...
local EngineCarI4 = {}
	EngineCarI4.id = "2.0-I4"
	EngineCarI4.ent = "acf_engine"
	EngineCarI4.type = "Mobility"
	EngineCarI4.name = "2.0L I4"
	EngineCarI4.desc = "Small and light car engine, with the powerband \n high up in the revs\n"
	EngineCarI4.model = "models/Gibs/airboat_broken_engine.mdl"
	EngineCarI4.sound = "vehicles/junker/jnk_fourth_cruise_loop2.wav"
	EngineCarI4.weight = 100
	EngineCarI4.torque = 20		--in Meter/Kg
	EngineCarI4.idlerpm = 1000	--in Rotations Per Minute
	EngineCarI4.peakminrpm = 5000
	EngineCarI4.peakmaxrpm = 7000
	EngineCarI4.limitprm = 8500
	if ( CLIENT ) then
		EngineCarI4.guicreate = (function( Panel, Table ) ACFEngineGUICreate( Table ) end or nil)
		EngineCarI4.guiupdate = function() return end
	end
MobilityTable["2.0-I4"] = EngineCarI4
